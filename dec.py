...
def mains(pu=0,pr=0):
	...
	root2=Toplevel()
	root2.title("Giải Mã RSA - Tang Ho Trung Nam")
	...
	button_ok=Label(root2,text="Private key",width=10,height=1,bg='#ffffff',fg='black',bd=0,font=('Calibri (Body)',11,'bold italic'))
